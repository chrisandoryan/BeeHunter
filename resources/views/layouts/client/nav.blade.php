    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown user user-menu">
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <img src="{{ asset(\Illuminate\Support\Facades\Auth::guard('client')->user()->image_profile) }}" class="user-image" alt="User Image">
          <!-- hidden-xs hides the username on small devices so only the image appears. -->
          <span class="hidden-xs">{{ \Illuminate\Support\Facades\Auth::guard('client')->user()->username }}</span>
        </a>
        <ul class="dropdown-menu">
          ...
          <li class="user-header">
            ...
            <p>
              ...
              <small>Client since Nov. 2012</small>
            </p>
          </li>
          <!-- Menu Body -->
          <li class="user-body">
